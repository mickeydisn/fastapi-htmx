...
from app.core.service.content.chart import htmlContentChart
...
def htmlContentPandaChartTimeSerie(df: pd.DataFrame, axe_index: str, series: list[SeriesConfig]):
    """
    ...
    chart_config = {
        ...
        "options": {
            ...
            "scales": {
                "x": {
                    "title": {"display": True, "text": axe_index},
                    "stacked": False
                },
                "y": {
                    "stacked": False,
...
def htmlContentPandaChartTimeSerie_exemple():
    ...
    return htmlContentPandaChartTimeSerie(df, "date", [
        ...
        SeriesConfig(column='profit2', type='line', color= "hsla(158, 40%, 50%, 1)", width=5),
    ])