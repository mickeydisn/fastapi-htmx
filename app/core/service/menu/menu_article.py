...
from app.core.service.menu.menu_label import htmlMenuLabelItem_ClickOnLabel
from app.core.service.menu.menu_label import htmlMenuLabelItem_ClickOnIcon
# -----------------------------------------------------------------------------
...
def htmlMenuH1_Group(title, groups, isOpen:bool=False):
    ...
    for keyGroup in groups.keys():
        arrayOfHtlmLabel =  [htmlMenuLabelItem_ClickOnIcon(**item) for item in groups[keyGroup]]
