...
def _content_Article():
    ...
    return htmlArticleH2("Sub Article Title", [subcontent, subcontent1], isOpen=True)
    ...
    return htmlArticleH2(
        ...
        innerSection=[
            ...
            htmlArticleH3(
                ...
                innerSection=[
                    htmlArticleH4(
                        "Article 1_1_1", isOpen=True, innerSection=[art1_1_1_content]
                    )
                ],
            ),
        ],
...
def htmlH1_Exemple2():
    ...
    for f in fns:
        article = htmlArticleH2(
            f.__name__, [htmlContentMDPyFunction(f), f()], isOpen=False
        )
