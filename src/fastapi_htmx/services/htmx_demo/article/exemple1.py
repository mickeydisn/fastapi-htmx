...
In your main FastAPI application file (`core.service.service_fastapi_htmx.py`), register the router:

```python
from fastapi_htmx.services.NAME.router import router as routerNAME

fastapi_htmx.include_router(routerNAME)
```
