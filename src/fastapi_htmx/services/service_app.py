...
from fastapi_htmx.services.htmx_demo.router import router as routerDemo
from fastapi_htmx.services.htmx_template.router import router as routerTemplate
